...
-- ----------------------------
-- Table structure for negative_examples
-- ----------------------------
DROP TABLE IF EXISTS `negative_examples`;
...
) ENGINE = InnoDB AUTO_INCREMENT = 61961 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
