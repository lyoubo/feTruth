...
-- ----------------------------
-- Table structure for testing_data_without_filtering
-- ----------------------------
DROP TABLE IF EXISTS `testing_data_without_filtering`;
CREATE TABLE `testing_data_without_filtering`
(
...
) ENGINE = InnoDB AUTO_INCREMENT = 872 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = DYNAMIC;
