...
def evaluate(projects):
    model = load_model('feTruth_without_filtering.h5')
    ...
    for project in projects:
        ...
        file = ROOT_PATH + 'data/testing-data/' + project + '_without_filtering.json'
        with open(file, encoding='utf-8') as f:
            ...
            for content in contents:
                if project == content['name']:
                    ...
                    print()
                    output += "\n"
        with open('output/' + project + '(feTruth_without_filtering).txt', mode='w', encoding='utf-8') as f:
